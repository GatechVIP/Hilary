...
var log = require('oae-logger').logger('rest.js');
...
OAE.tenantRouter.on('post', '/api/discussion/create', function(req, res) {
    ...
    // Type coerce opt.isQa to boolean
    var opts = {};
    opts.isQa = (req.body.isQa === 'true');

    DiscussionsAPI.Discussions.createDiscussion(req.ctx, req.body.displayName, req.body.description, req.body.visibility, members, opts, function(err, discussion) {
        if (err) {
